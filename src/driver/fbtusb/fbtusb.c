...
VOID FreeBT_DriverUnload(IN PDRIVER_OBJECT DriverObject);
NTSTATUS FreeBT_AddDevice(IN PDRIVER_OBJECT DriverObject, IN PDEVICE_OBJECT PhysicalDeviceObject);
