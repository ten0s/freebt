...
public:
   ...
   virtual DWORD SendReadBDADDR(FBT_HCI_READ_BD_ADDR_COMPLETE &CommandComplete);
   virtual DWORD SendReadBufferSize(FBT_HCI_READ_BUFFER_SIZE_COMPLETE &CommandComplete);
